  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (parallaxElement) {
        ...
        const backgroundImage = parallaxElement.querySelector('.parallax-bg') as HTMLElement;
        if (backgroundImage) {
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-center z-10">
          <div className="text-center">
            ...
            <div className="flex justify-center">
              <button className="border-2 border-white text-white hover:bg-white hover:text-exoset-blue px-8 py-4 rounded-full font-semibold text-lg transition-all duration-200">
      ...
      <div className="relative z-20 mt-screen">
        <ScrollExpandingCard className="bg-white rounded-t-3xl shadow-2xl min-h-screen">
          {/* Services Overview */}
          <section className="pt-20 pb-20 bg-gray-50 rounded-t-3xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              son activité en 3 pôles distincts et complémentaires.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                ...
                Synology et VMWare, sécurité et réseau avec Fortinet, Cisco et Kemp.
              </p>
            </div>
          ...
          <div className="relative">
            ...
            <div className="hidden md:block absolute top-16 left-0 right-0 h-1 bg-gradient-to-r from-exoset-blue to-exoset-pink rounded-full">
              ...
              <div className="absolute right-0 top-1/2 h-4 w-4 -translate-y-1/2 translate-x-1/2">
                <svg className="w-full h-full text-exoset-pink" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {[
                {
                  number: "1",
                  title: "Analyse",
                  description: "Évaluation de vos besoins et de votre infrastructure actuelle."
                },
                {
                  number: "2", 
                  title: "Implémentation",
                  description: "Déploiement des solutions adaptées à vos objectifs spécifiques."
                },
                {
                  number: "3",
                  title: "Accompagnement",
                  description: "Formation et support pour une maîtrise complète des outils."
                }
              ].map((step, index) => (
      ...
      {/* Parallax Divider */}
      <section id="parallax-divider" className="relative h-64 overflow-hidden">
        <div 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { 
                title: 'Cloud', 
                desc: 'Azure, SaaS, PaaS, IaaS, MS 365',
                icon: (
              ...
              { 
                title: 'Réseau', 
                desc: 'Load Balancer, commutation et routage, WiFi',
                icon: (
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              { 
                ...
                desc: 'HyperV, VMware, Fortinet Vdom',
                icon: (
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01" />
                  </svg>
              ...
              { 
                title: 'Sécurité', 
                desc: 'Firewall, micro-segmentation, support',
                icon: (
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              { 
                ...
                desc: 'Synology NAS, Dell SAN, cloud',
                icon: (
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 cursor-pointer group relative">
                <div className="mb-4">
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke={`url(#expertiseGradient${index})`} strokeWidth={2}>
                    <defs>
                      <linearGradient id={`expertiseGradient${index}`} x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-exoset-blue group-hover:to-exoset-pink transition-all duration-300">{item.title}</h3>
                <p className="text-gray-600 text-sm">{item.desc}</p>
                
                {/* Arrow indicator */}
                <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <svg className="w-5 h-5 text-exoset-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative">
            ...
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
              <svg className="w-12 h-12 text-exoset-pink opacity-30" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="overflow-hidden">
              <div className="flex transition-transform duration-500 ease-in-out" style={{transform: `translateX(-${currentQuote * 100}%)`}}>
                {[
                  {
                  ...
                  },
                  {
                    ...
                    title: "Responsable Informatique, Industries Laval Inc."
                  }
                ].map((quote, index) => (
                  <div key={index} className="w-full flex-shrink-0 text-center px-4">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-lg font-semibold text-gray-900">{quote.author}</p>
            ...
            <div>
              ...
              <div className="text-gray-400 space-y-2">
                ...
                <div className="flex space-x-4 mt-4">
                  <a href="#" className="text-exoset-cyan hover:text-white">LinkedIn</a>
                  <a href="#" className="text-exoset-cyan hover:text-white">Facebook</a>
                </div>
              </div>
            </div>
          </div>
